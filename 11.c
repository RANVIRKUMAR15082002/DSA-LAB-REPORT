/* Write a program using C to implement stack using linked list. */
/* Stack implementation using linked list in C language. */
#include<stdio.h>
#include<stdlib.h>
#include<limits.h>  // For INT_MIN.
#define CAPACITY 50  // Stack maximum capacity.
    ...
    while(1)
    {
        ...
        switch(choice)
        {
            ...
            case 2: 
                ...
                if (data != INT_MIN)
                    printf("Data, which is poped => %d.", data);
                break;
            case 3: 
